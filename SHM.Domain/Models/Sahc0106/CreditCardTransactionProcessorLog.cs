...
/*
[Table("CreditCardTransactionProcessorLog", Schema = "Sahc0106")]
public class CreditCardTransactionProcessorLog
{
...
public class CreditCardTransactionProcessorLog
{
    ...
    /// <summary>
    /// Llave primaria de la tabla CreditCardTransactionProcessorLog
    /// </summary>
    [Key]
    public Guid CreditCardTransactionProcessorLogKey { get; set; }

    /// <summary>
    /// Llave foranea de la tabla CreditCardTransactionProcessor
    /// </summary>
    [ForeignKey("CreditCardTransactionProcessor")]
    public Guid CreditCardTransactionProcessorKey { get; set; }
    ...
    /// <summary>
    /// Campo para registrar el numero de aprobacion que permite generar el log.
    /// </summary>
