...
[Table("CreditCardTranProcessorCycleLog", Schema = "Sahc0106")]
public class CreditCardTranProcessorCycleLog
{
    

    /// <summary>
    /// Llave primaria de la tabla CreditCardTranProcessorCycleLog
    /// </summary>
    [Key]
