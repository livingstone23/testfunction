...
/*
[Table("CreditCardTransactionProcessor", Schema = "Sahc0106")]
public class CreditCardTransactionProcessor
{
    ...
    [ForeignKey("CreditCardBalanceKey")]
    ...
    //[Column(TypeName = "decimal(18, 4)")]
    //public decimal? TotalPays { get; set; }         //Total Pagos
    ...
    //[Column(TypeName = "decimal(18, 4)")]
    //public decimal PaymentPlanDebtDate { get; set; }        //Deuda a la fecha

    //[Column(TypeName = "decimal(18, 4)")]
    //public decimal PaymentPlanBalance { get; set; }         //Saldo a la fecha del plan
    ...
    public List<CreditCardTransactionProcessorDetail> CreditCardTransactionProcessorDetails { get; set; }

    public List<CreditCardTransactionProcessorLog> CreditCardTransactionProcessorLogs { get; set; }
...
public class CreditCardTransactionProcessor
{
    ...
    /// <summary>
    /// Llave primaria de la tabla CreditCardTransactionProcessor
    /// </summary>
    [Key]
    public Guid CreditCardTransactionProcessorKey { get; set; }
    ...
    /// <summary>
    /// Campo para relacionar con la tabla CreditCardMasterGeneral
    /// </summary>
    public Guid CreditCardMasterGeneralKey { get; set; }
    ...
    /// <summary>
    /// Campo para relacionar con la tabla CreditCardBalance
    /// </summary>
    public Guid CreditCardBalanceKey { get; set; }
